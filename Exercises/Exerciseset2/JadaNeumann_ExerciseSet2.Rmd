...
We need 6 components to explain at least 50% of the variance in this data

Question 2:

5 yr T-Notes US (0.93) / 10yr T-Notes (0.93) / Treasury Bonds (0.86)

Question 3:

1: Bonds / 2: Currencies / 3: Large-Cap European Stock Indices / 4: Small-Cap American Stock Indices / 5: European Fixed Income Futures / 6: Oil / 7: Metals / 8: Agricultural Commodities / 9: Precious Metals / 10: Asian Stock Indices

Question 4:

a) Pre-crisis bull market years (Nov. 1, 2002 to Oct. 1, 2007)
- Subset the years, perform PCA, put into table form, plot scree chart
...
b) Financial crisis years (Oct. 1, 2007 to  Mar. 1, 2009)
- Subset the years, perform PCA, put into table form, plot scree chart
...
Fewer components are required to explain futures performance in bear markets, implying that returns are more correlated.  Portfolio diversification would be more difficult to achieve in this environment.
