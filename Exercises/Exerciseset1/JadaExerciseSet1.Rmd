...
Question 1:
* The line `mytickers = c("SPY", "AAPL").  From file `dataset1.R`.

Question 2:
* The cumulative returns of Apple during this period is 596.41%.
* The average daily returns of Apple during this period is 0.148%;
* The standard deviation of the daily returns of Apple during this period is 2.39%

Question 3:
* Add  ,"YHOO"  after "AAPL" in the line `mytickers = c("SPY", "AAPL") from file `dataset1.R`.
...
Question 1:
* nrow(transposedData) and ncol(transposedData)
...
Question 1:
* Make the line`startDate = "2001-01-01"` in file `dataSet1.R`

Question 2:
* Add the new tickers  after "AAPL" in the line `mytickers = c("SPY", "AAPL") from file `dataset1.R`.
...
Question 1:
* It says: Error: object 'sum(myData != StockReturns[1:20,])' not found
