...
1. Factor 1 relates to status
   ...
   Factor 2 relates to recreation
...
2. We would chose <> factors

   a) Statistical Justification:
      5 components have eigenvalues greater than 1 (average)
   
   b) Interpretation Justification:
